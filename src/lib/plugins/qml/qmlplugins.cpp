...
void QmlPlugins::registerQmlTypes()
{
    ...
    // TopSites
    qmlRegisterUncreatableType<QmlMostVisitedUrl>(url, majorVersion, minorVersion, "MostVisitedURL", "Unable to register type: MostVisitedURL");
    ...
    // History
    qmlRegisterUncreatableType<QmlHistoryItem>(url, majorVersion, minorVersion, "HistoryItem", "Unable to register type: HistoryItem");
    ...
    // Tabs
    qmlRegisterUncreatableType<QmlTab>(url, majorVersion, minorVersion, "Tab", "Unable to register type: Tab");
    ...
    // Windows
    qmlRegisterUncreatableType<QmlWindow>(url, majorVersion, minorVersion, "Window", "Unable to register type: Window");

    qmlRegisterUncreatableType<QmlWindowState>(url, majorVersion, minorVersion, "WindowState", "Unable to register type: WindowState");

    qmlRegisterUncreatableType<QmlWindowType>(url, majorVersion, minorVersion, "WindowType", "Unable to register type: WindowType");
    ...
    // Menu
    qmlRegisterUncreatableType<QmlMenu>(url, majorVersion, minorVersion, "Menu", "Unable to register type: Menu");

    // Action
    qmlRegisterUncreatableType<QmlAction>(url, majorVersion, minorVersion, "Action", "Unable to register type: Action");

    // WebHitTestResult
    qmlRegisterUncreatableType<QmlWebHitTestResult>(url, majorVersion, minorVersion, "WebHitTestResult", "Unable to register type: WebHitTestResult");

    // Settings
    qmlRegisterType<QmlSettings>(url, majorVersion, minorVersion, "Settings");

    // Qz::Objects
    qmlRegisterUncreatableType<QmlQzObjects>(url, majorVersion, minorVersion, "QzObjects", "Unable to register type: QzObjects");

    // MouseEvents
    qmlRegisterUncreatableType<QmlMouseEvent>(url, majorVersion, minorVersion, "MouseEvent", "Unable to register type: MouseEvent");

    // WheelEvents
    qmlRegisterUncreatableType<QmlWheelEvent>(url, majorVersion, minorVersion, "WheelEvent", "Unable to register type: WheelEvent");
    ...
    qmlRegisterUncreatableType<QmlWebEngineUrlRequestJob>(url, majorVersion, minorVersion, "WebEngineUrlRequestJob", "Unable to register type: WebEngineUrlRequestJob");
